...
public class class_0739 {
    ...
    public void lllIIIllIIIIlllIlIIllIIll(List list) {
        ...
        if (this.lIlIllIIlIIlIIlIIlIIlIIll != this.lllIIIllIIIIlllIlIIllIIll.IlIIIlIIIIllIIIllIIIIIIll || this.lllIIIllIIIIlllIlIIllIIll.IlIIIlIIIIllIIIllIIIIIIll != null && this.llIIllIllIlIIlIIllIllllll % 60 == 0) {
            ...
            this.lllIIIllIIIIlllIlIIllIIll(new S1BPacketEntityAttach(0, this.lllIIIllIIIIlllIlIIllIIll, this.lllIIIllIIIIlllIlIIllIIll.IlIIIlIIIIllIIIllIIIIIIll));
        }
        if (this.lllIIIllIIIIlllIlIIllIIll instanceof class_1094 && this.llIIllIllIlIIlIIllIllllll % 10 == 0) {
            ...
            if (class_08972 != null && class_08972.lllIIIllIIIIlllIlIIllIIll() instanceof class_0746) {
                ...
                for (class_0814 class_08142 : list) {
                    ...
                    Packet class_07032 = Items.IIIIIlllIIllllIlllIlllIIl.lIlllIlllIIIIlIIlllIllIII(class_08972, this.lllIIIllIIIIlllIlIIllIIll.lIlIllIIlIIlIIlIIlIIlIIll, class_18222);
            ...
            if (this.lllIIIllIIIIlllIlIIllIIll.IlIIIlIIIIllIIIllIIIIIIll == null) {
                ...
                if (this.llIIllIllIlIIlIIllIllllll > 0 || this.lllIIIllIIIIlllIlIIllIIll instanceof class_0369) {
                    if (n6 >= -128 && n6 < 128 && n7 >= -128 && n7 < 128 && n8 >= -128 && n8 < 128 && this.IIlllIlIlllIllIIIlllIIlIl <= 400 && !this.llIIlIllIllllIlIIIIlIIlll) {
                        if (bl2 && bl) {
                            class_07033 = new S14PacketEntity_S17PacketEntityLookMove(this.lllIIIllIIIIlllIlIIllIIll.llllllIlIllllIlIlIlIIIIlI(), (byte)n6, (byte)n7, (byte)n8, (byte)n4, (byte)n5);
                        } else if (bl2) {
                            class_07033 = new S14PacketEntity_S15PacketEntityRelMove(this.lllIIIllIIIIlllIlIIllIIll.llllllIlIllllIlIlIlIIIIlI(), (byte)n6, (byte)n7, (byte)n8);
                        } else if (bl) {
                            class_07033 = new S14PacketEntity_S16PacketEntityLook(this.lllIIIllIIIIlllIlIIllIIll.llllllIlIllllIlIlIlIIIIlI(), (byte)n4, (byte)n5);
                        }
                    } else {
                        this.IIlllIlIlllIllIIIlllIIlIl = 0;
                        class_07033 = new S18PacketEntityTeleport(this.lllIIIllIIIIlllIlIIllIIll.llllllIlIllllIlIlIlIIIIlI(), n, n2, n3, (byte)n4, (byte)n5);
                    }
                }
                if (this.IlIIIlIIIIllIIIllIIIIIIll && ((d5 = (d4 = this.lllIIIllIIIIlllIlIIllIIll.IIIIIIIIlIllIIllIIlllIllI - this.IllIIIllIIIIlIlIlIllIIlll) * d4 + (d3 = this.lllIIIllIIIIlllIlIIllIIll.IIlIIlIlIlIllIIlIlIIIIlll - this.lIIIIlIlIIlllllIIllIIlIII) * d3 + (d2 = this.lllIIIllIIIIlllIlIIllIIll.llIIIlllIlllIlIllIIIIllIl - this.llIIlllIllIllllIIIlIIIIII) * d2) > (d = 0.02) * d || d5 > 0.0 && this.lllIIIllIIIIlllIlIIllIIll.IIIIIIIIlIllIIllIIlllIllI == 0.0 && this.lllIIIllIIIIlllIlIIllIIll.IIlIIlIlIlIllIIlIlIIIIlll == 0.0 && this.lllIIIllIIIIlllIlIIllIIll.llIIIlllIlllIlIllIIIIllIl == 0.0)) {
                    ...
                    this.lllIIIllIIIIlllIlIIllIIll(new S12PacketEntityVelocity(this.lllIIIllIIIIlllIlIIllIIll.llllllIlIllllIlIlIlIIIIlI(), this.IllIIIllIIIIlIlIlIllIIlll, this.lIIIIlIlIIlllllIIllIIlIII, this.llIIlllIllIllllIIIlIIIIII));
                }
                if (class_07033 != null) {
                ...
                if (bl) {
                    this.lllIIIllIIIIlllIlIIllIIll(new S14PacketEntity_S16PacketEntityLook(this.lllIIIllIIIIlllIlIIllIIll.llllllIlIllllIlIlIlIIIIlI(), (byte)n, (byte)n9));
            ...
            if (Math.abs(n - this.IIIllIllIIlIlIlIlIllllIIl) >= 4) {
                this.lllIIIllIIIIlllIlIIllIIll(new S19PacketEntityHeadLook(this.lllIIIllIIIIlllIlIIllIIll, (byte)n));
        ...
        if (this.lllIIIllIIIIlllIlIIllIIll.lllIIIIIIlIlllIIlIlIIIllI) {
            this.lllIlIIlIIIlIlIIIllIlllIl(new S12PacketEntityVelocity(this.lllIIIllIIIIlllIlIIllIIll));
    ...
    private void lllIlIIlIIIlIlIIIllIlllIl() {
        ...
        if (class_07882.lllIIIllIIIIlllIlIIllIIll()) {
            this.lllIlIIlIIIlIlIIIllIlllIl(new S1CPacketEntityMetadata(this.lllIIIllIIIIlllIlIIllIIll.llllllIlIllllIlIlIlIIIIlI(), class_07882, false));
        }
        if (this.lllIIIllIIIIlllIlIIllIIll instanceof class_1965) {
            ...
            if (!set.isEmpty()) {
                this.lllIlIIlIIIlIlIIIllIlllIl(new S20PacketEntityProperties(this.lllIIIllIIIIlllIlIIllIIll.llllllIlIllllIlIlIlIIIIlI(), set));
            }
            set.clear();
        }
    }
    ...
    public void lllIlIIlIIIlIlIIIllIlllIl(Packet class_07032) {
        ...
        if (class_18222 != this.lllIIIllIIIIlllIlIIllIIll) {
            ...
            if (d >= (double)(-this.lllIlIIlIIIlIlIIIllIlllIl) && d <= (double)this.lllIlIIlIIIlIlIIIllIlllIl && d2 >= (double)(-this.lllIlIIlIIIlIlIIIllIlllIl) && d2 <= (double)this.lllIlIIlIIIlIlIIIllIlllIl) {
                if (!this.IlIlllIIIIIIlIIllIIllIlll.contains(class_18222) && (this.lIlllIlllIIIIlIIlllIllIII(class_18222) || this.lllIIIllIIIIlllIlIIllIIll.IIlllIlIlllIllIIIlllIIlIl)) {
                    ...
                    Packet class_07032 = this.IlIllllllIIlIIllllIIlIIIl();
                    class_18222.lllIIIllIIIIlllIlIIllIIll.lllIIIllIIIIlllIlIIllIIll(class_07032);
                    if (!this.lllIIIllIIIIlllIlIIllIIll.lIlIIllllIlIIIIllIIIIlIIl().lIlllIlllIIIIlIIlllIllIII()) {
                        class_18222.lllIIIllIIIIlllIlIIllIIll.lllIIIllIIIIlllIlIIllIIll(new S1CPacketEntityMetadata(this.lllIIIllIIIIlllIlIIllIIll.llllllIlIllllIlIlIlIIIIlI(), this.lllIIIllIIIIlllIlIIllIIll.lIlIIllllIlIIIIllIIIIlIIl(), true));
                    }
                    if (this.lllIIIllIIIIlllIlIIllIIll instanceof class_1965 && !(object2 = ((class_1539)(object = (class_1539)((class_1965)this.lllIIIllIIIIlllIlIIllIIll).lIlIllllIlIIIIIllIIIIlIlI())).IlIllllllIIlIIllllIIlIIIl()).isEmpty()) {
                        class_18222.lllIIIllIIIIlllIlIIllIIll.lllIIIllIIIIlllIlIIllIIll(new S20PacketEntityProperties(this.lllIIIllIIIIlllIlIIllIIll.llllllIlIllllIlIlIlIIIIlI(), (Collection)object2));
                    }
                    this.IllIIIllIIIIlIlIlIllIIlll = this.lllIIIllIIIIlllIlIIllIIll.IIIIIIIIlIllIIllIIlllIllI;
                    this.lIIIIlIlIIlllllIIllIIlIII = this.lllIIIllIIIIlllIlIIllIIll.IIlIIlIlIlIllIIlIlIIIIlll;
                    this.llIIlllIllIllllIIIlIIIIII = this.lllIIIllIIIIlllIlIIllIIll.llIIIlllIlllIlIllIIIIllIl;
                    if (this.IlIIIlIIIIllIIIllIIIIIIll && !(class_07032 instanceof S0FPacketSpawnMob)) {
                        class_18222.lllIIIllIIIIlllIlIIllIIll.lllIIIllIIIIlllIlIIllIIll(new S12PacketEntityVelocity(this.lllIIIllIIIIlllIlIIllIIll.llllllIlIllllIlIlIlIIIIlI(), this.lllIIIllIIIIlllIlIIllIIll.IIIIIIIIlIllIIllIIlllIllI, this.lllIIIllIIIIlllIlIIllIIll.IIlIIlIlIlIllIIlIlIIIIlll, this.lllIIIllIIIIlllIlIIllIIll.llIIIlllIlllIlIllIIIIllIl));
                    }
                    if (this.lllIIIllIIIIlllIlIIllIIll.IlIIIlIIIIllIIIllIIIIIIll != null) {
                        class_18222.lllIIIllIIIIlllIlIIllIIll.lllIIIllIIIIlllIlIIllIIll(new S1BPacketEntityAttach(0, this.lllIIIllIIIIlllIlIIllIIll, this.lllIIIllIIIIlllIlIIllIIll.IlIIIlIIIIllIIIllIIIIIIll));
                    }
                    if (this.lllIIIllIIIIlllIlIIllIIll instanceof class_0339 && ((class_0339)this.lllIIIllIIIIlllIlIIllIIll).lIIIlllIlIIIlIllIIIlIllll() != null) {
                        class_18222.lllIIIllIIIIlllIlIIllIIll.lllIIIllIIIIlllIlIIllIIll(new S1BPacketEntityAttach(1, this.lllIIIllIIIIlllIlIIllIIll, ((class_0339)this.lllIIIllIIIIlllIlIIllIIll).lIIIlllIlIIIlIllIIIlIllll()));
                    }
                    if (this.lllIIIllIIIIlllIlIIllIIll instanceof class_1965) {
                        for (int i = 0; i < 5; ++i) {
                            object2 = ((class_1965)this.lllIIIllIIIIlllIlIIllIIll).IlIllllllIIlIIllllIIlIIIl(i);
                            if (object2 == null) continue;
                            class_18222.lllIIIllIIIIlllIlIIllIIll.lllIIIllIIIIlllIlIIllIIll(new S04PacketEntityEquipment(this.lllIIIllIIIIlllIlIIllIIll.llllllIlIllllIlIlIlIIIIlI(), i, (ItemStack)object2));
                        }
                    }
                    if (this.lllIIIllIIIIlllIlIIllIIll instanceof class_0814 && ((class_0814)(object = (class_0814)this.lllIIIllIIIIlllIlIIllIIll)).IIIIIllIIlIlIlIIlIlIlIllI()) {
                        class_18222.lllIIIllIIIIlllIlIIllIIll.lllIIIllIIIIlllIlIIllIIll(new S0APacketUseBed((class_0814)object, MathHelper.IlIllllllIIlIIllllIIlIIIl(this.lllIIIllIIIIlllIlIIllIIll.IlIIlllllIIlIlIlllllIllll), MathHelper.IlIllllllIIlIIllllIIlIIIl(this.lllIIIllIIIIlllIlIIllIIll.llIIlIlIlllIIllIlIlllIllI), MathHelper.IlIllllllIIlIIllllIIlIIIl(this.lllIIIllIIIIlllIlIIllIIll.IllIIIIllIIllIllIlllIlIIl)));
                    }
                    if (this.lllIIIllIIIIlllIlIIllIIll instanceof class_1965) {
                        object = (class_1965)this.lllIIIllIIIIlllIlIIllIIll;
                        for (class_1852 class_18522 : ((class_1965)object).IIllIIIlIIllllIIIIIIIIlll()) {
                            class_18222.lllIIIllIIIIlllIlIIllIIll.lllIIIllIIIIlllIlIIllIIll(new S1DPacketEntityEffect(this.lllIIIllIIIIlllIlIIllIIll.llllllIlIllllIlIlIlIIIIlI(), class_18522));
                        }
                    }
                }
    ...
    private Packet IlIllllllIIlIIllllIIlIIIl() {
        ...
        if (this.lllIIIllIIIIlllIlIIllIIll instanceof class_1781) {
            return new S0EPacketSpawnObject(this.lllIIIllIIIIlllIlIIllIIll, 2, 1);
        }
        if (this.lllIIIllIIIIlllIlIIllIIll instanceof class_1822) {
            return new S0CPacketSpawnPlayer((class_0814)this.lllIIIllIIIIlllIlIIllIIll);
        }
        if (this.lllIIIllIIIIlllIlIIllIIll instanceof class_1860) {
            class_1860 class_18602 = (class_1860)this.lllIIIllIIIIlllIlIIllIIll;
            return new S0EPacketSpawnObject(this.lllIIIllIIIIlllIlIIllIIll, 10, class_18602.IlIllllllIIlIIllllIIlIIIl());
        }
        if (this.lllIIIllIIIIlllIlIIllIIll instanceof class_2263) {
            return new S0EPacketSpawnObject(this.lllIIIllIIIIlllIlIIllIIll, 1);
        }
        if (!(this.lllIIIllIIIIlllIlIIllIIll instanceof class_1463) && !(this.lllIIIllIIIIlllIlIIllIIll instanceof class_1221)) {
            if (this.lllIIIllIIIIlllIlIIllIIll instanceof class_2050) {
                ...
                return new S0EPacketSpawnObject(this.lllIIIllIIIIlllIlIIllIIll, 90, class_08142 != null ? class_08142.llllllIlIllllIlIlIlIIIIlI() : this.lllIIIllIIIIlllIlIIllIIll.llllllIlIllllIlIlIlIIIIlI());
            }
            if (this.lllIIIllIIIIlllIlIIllIIll instanceof class_0369) {
                ...
                return new S0EPacketSpawnObject(this.lllIIIllIIIIlllIlIIllIIll, 60, class_15212 != null ? class_15212.llllllIlIllllIlIlIlIIIIlI() : this.lllIIIllIIIIlllIlIIllIIll.llllllIlIllllIlIlIlIIIIlI());
            }
            if (this.lllIIIllIIIIlllIlIIllIIll instanceof class_0333) {
                return new S0EPacketSpawnObject(this.lllIIIllIIIIlllIlIIllIIll, 61);
            }
            if (this.lllIIIllIIIIlllIlIIllIIll instanceof class_0426) {
                return new S0EPacketSpawnObject(this.lllIIIllIIIIlllIlIIllIIll, 73, ((class_0426)this.lllIIIllIIIIlllIlIIllIIll).lIllllIIlIIIlIllllllIIIll());
            }
            if (this.lllIIIllIIIIlllIlIIllIIll instanceof class_1617) {
                return new S0EPacketSpawnObject(this.lllIIIllIIIIlllIlIIllIIll, 75);
            }
            if (this.lllIIIllIIIIlllIlIIllIIll instanceof class_1918) {
                return new S0EPacketSpawnObject(this.lllIIIllIIIIlllIlIIllIIll, 65);
            }
            if (this.lllIIIllIIIIlllIlIIllIIll instanceof class_0093) {
                return new S0EPacketSpawnObject(this.lllIIIllIIIIlllIlIIllIIll, 72);
            }
            if (this.lllIIIllIIIIlllIlIIllIIll instanceof class_1800) {
                return new S0EPacketSpawnObject(this.lllIIIllIIIIlllIlIIllIIll, 76);
            }
            if (this.lllIIIllIIIIlllIlIIllIIll instanceof class_1937) {
                class_1937 class_19372 = (class_1937)this.lllIIIllIIIIlllIlIIllIIll;
                S0EPacketSpawnObject class_16312 = null;
                int n = 63;
                ...
                class_16312 = class_19372.lllIIIllIIIIlllIlIIllIIll != null ? new S0EPacketSpawnObject(this.lllIIIllIIIIlllIlIIllIIll, n, ((class_1937)this.lllIIIllIIIIlllIlIIllIIll).lllIIIllIIIIlllIlIIllIIll.llllllIlIllllIlIlIlIIIIlI()) : new S0EPacketSpawnObject(this.lllIIIllIIIIlllIlIIllIIll, n, 0);
            ...
            if (this.lllIIIllIIIIlllIlIIllIIll instanceof class_0525) {
                return new S0EPacketSpawnObject(this.lllIIIllIIIIlllIlIIllIIll, 62);
            }
            if (this.lllIIIllIIIIlllIlIIllIIll instanceof class_0034) {
                return new S0EPacketSpawnObject(this.lllIIIllIIIIlllIlIIllIIll, 50);
            }
            if (this.lllIIIllIIIIlllIlIIllIIll instanceof class_0355) {
                return new S0EPacketSpawnObject(this.lllIIIllIIIIlllIlIIllIIll, 51);
            }
            if (this.lllIIIllIIIIlllIlIIllIIll instanceof class_0543) {
                class_0543 class_05432 = (class_0543)this.lllIIIllIIIIlllIlIIllIIll;
                return new S0EPacketSpawnObject(this.lllIIIllIIIIlllIlIIllIIll, 70, Block.lllIIIllIIIIlllIlIIllIIll(class_05432.lIlllIlllIIIIlIIlllIllIII()) | class_05432.lllIIIllIIIIlllIlIIllIIll << 16);
            }
            if (this.lllIIIllIIIIlllIlIIllIIll instanceof class_0146) {
                return new S10PacketSpawnPainting((class_0146)this.lllIIIllIIIIlllIlIIllIIll);
            }
            if (this.lllIIIllIIIIlllIlIIllIIll instanceof class_1094) {
                class_1094 class_10942 = (class_1094)this.lllIIIllIIIIlllIlIIllIIll;
                S0EPacketSpawnObject class_16313 = new S0EPacketSpawnObject(this.lllIIIllIIIIlllIlIIllIIll, 71, class_10942.lllIIIllIIIIlllIlIIllIIll);
            ...
            if (this.lllIIIllIIIIlllIlIIllIIll instanceof class_1215) {
                ...
                S0EPacketSpawnObject class_16314 = new S0EPacketSpawnObject(this.lllIIIllIIIIlllIlIIllIIll, 77);
            ...
            if (this.lllIIIllIIIIlllIlIIllIIll instanceof class_1138) {
                return new S11PacketSpawnExperienceOrb((class_1138)this.lllIIIllIIIIlllIlIIllIIll);
            }
        ...
        return new S0FPacketSpawnMob((class_1965)this.lllIIIllIIIIlllIlIIllIIll);
    }
