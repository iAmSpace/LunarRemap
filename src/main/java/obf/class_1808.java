...
public class class_1808 {
    ...
    private final ResourceLocation lIllllIIlIIIlIllllllIIIll;

    public class_1808(String string, String string2, String string3, String string4, String string5) {
        ...
        this.IlIIIIIllllllIIlllIllllll = string5;
        this.lIllllIIlIIIlIllllllIIIll = LunarClient.getInstance().lllIIIllIIIIlllIlIIllIIll(string4, string5);
    }
