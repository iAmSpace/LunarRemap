 ...
 */
public class class_2185
extends class_0323 {
    float lllIIIllIIIIlllIlIIllIIll;

    public class_2185(class_1334 class_13342, double d, double d2, double d3, double d4, double d5, double d6) {
        this(class_13342, d, d2, d3, d4, d5, d6, 1.0f);
    }

    public class_2185(class_1334 class_13342, double d, double d2, double d3, double d4, double d5, double d6, float f) {
        ...
        this.lIIIIlIlIIlllllIIllIIlIII = this.llIIlllIllIllllIIIlIIIIII = (float)(Math.random() * (double)0.3f);
