...
extends class_1197 {
    ...
    public void lllIIIllIIIIlllIlIIllIIll(Minecraft class_06672, int n, int n2) {
        if (this.lIIIIlIlIIlllllIIllIIlIII) {
            ...
            LunarClient.getInstance().robotoLight16px.lllIlIIlIIIlIlIIIllIlllIl(this.IllIIlllllllIIlIIlIIIIlIl, this.lIllllIIlIIIlIllllllIIIll + this.lIlllIlllIIIIlIIlllIllIII / 2, this.IIIllIIlIIIIIIlIlIIllIIlI + this.IlIIIIIllllllIIlllIllllll / 2 - (this.lllIIIllIIIIlllIlIIllIIll ? 6 : 5), n4);
            GL11.glColor4f((float)1.0f, (float)1.0f, (float)1.0f, (float)0.3f);
            class_0857.lllIIIllIIIIlllIlIIllIIll(this.lllIlIIlIIIlIlIIIllIlllIl, 7.0f, (float)(this.lIllllIIlIIIlIllllllIIIll + this.lIlllIlllIIIIlIIlllIllIII - 20), (float)(this.IIIllIIlIIIIIIlIlIIllIIlI + 5));
        }
    }
}
