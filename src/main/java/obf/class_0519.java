...
extends class_0220 {
    ...
    public class_0519(Minecraft class_06672, String string, String string2, class_1078 class_10782) {
    ...
    protected boolean lllIIIllIIIIlllIlIIllIIll() {
        ...
        this.lllIIIllIIIIlllIlIIllIIll(class_0936.lllIlIIlIIIlIlIIIllIlllIl());
    ...
    public String lllIIIllIIIIlllIlIIllIIll(class_2243 class_22432, boolean bl) {
        try {
            int n = -1;
            try {
                n = class_0790.lllIIIllIIIIlllIlIIllIIll();
            }
    ...
    public void lIIIIlIlIIlllllIIllIIlIII() {
        super.lIIIIlIlIIlllllIIllIIlIII();
