...
extends class_0318 {
    ...
    public class_1159(class_0342 class_03422) {
        this.lllllIlllIIllIlIIlIIIllII = class_03422;
        super(class_03422);
        this.lllIlIIlIIIlIlIIIllIlllIl = new ArrayList();
        for (class_1536 class_15362 : StatList.IlIIIIIllllllIIlllIllllll) {
            boolean bl = false;
            ...
            if (class_0342.IlIllllllIIlIIllllIIlIIIl(class_03422).lllIIIllIIIIlllIlIIllIIll(class_15362) > 0) {
                bl = true;
            } else if (StatList.IIlIIlIlIlIllIIlIlIIIIlll[n] != null && class_0342.IlIllllllIIlIIllllIIlIIIl(class_03422).lllIIIllIIIIlllIlIIllIIll(StatList.IIlIIlIlIlIllIIlIlIIIIlll[n]) > 0) {
                bl = true;
        ...
        this.llIIllIllIlIIlIIllIllllll = new class_1409(this, class_03422);
    }
    ...
    protected void lllIIIllIIIIlllIlIIllIIll(int n, int n2, class_0868 class_08682) {
        ...
        if (this.lllIIIllIIIIlllIlIIllIIll == 0) {
            class_0342.lllIIIllIIIIlllIlIIllIIll(this.lllllIlllIIllIlIIlIIIllII, n + 115 - 18 + 1, n2 + 1 + 1, 18, 18);
        } else {
            class_0342.lllIIIllIIIIlllIlIIllIIll(this.lllllIlllIIllIlIIlIIIllII, n + 115 - 18, n2 + 1, 18, 18);
        }
        if (this.lllIIIllIIIIlllIlIIllIIll == 1) {
            class_0342.lllIIIllIIIIlllIlIIllIIll(this.lllllIlllIIllIlIIlIIIllII, n + 165 - 18 + 1, n2 + 1 + 1, 36, 18);
        } else {
            class_0342.lllIIIllIIIIlllIlIIllIIll(this.lllllIlllIIllIlIIlIIIllII, n + 165 - 18, n2 + 1, 36, 18);
        }
        if (this.lllIIIllIIIIlllIlIIllIIll == 2) {
            class_0342.lllIIIllIIIIlllIlIIllIIll(this.lllllIlllIIllIlIIlIIIllII, n + 215 - 18 + 1, n2 + 1 + 1, 54, 18);
        } else {
            class_0342.lllIIIllIIIIlllIlIIllIIll(this.lllllIlllIIllIlIIlIIIllII, n + 215 - 18, n2 + 1, 54, 18);
        }
    }
    ...
    protected void lllIIIllIIIIlllIlIIllIIll(int n, int n2, int n3, int n4, class_0868 class_08682, int n5, int n6) {
        ...
        this.lllIIIllIIIIlllIlIIllIIll(StatList.IIIIIIIIlIllIIllIIlllIllI[n7], n2 + 115, n3, n % 2 == 0);
        this.lllIIIllIIIIlllIlIIllIIll(StatList.IIlIIlIlIlIllIIlIlIIIIlll[n7], n2 + 165, n3, n % 2 == 0);
