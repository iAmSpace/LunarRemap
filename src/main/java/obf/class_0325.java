...
extends class_2117 {
    ...
    public class_0325(class_1609 class_16092, float f) {
        super(f);
    ...
    public void lllIIIllIIIIlllIlIIllIIll(int n, int n2, float f) {
        LunarClient.getInstance().ubuntuMedium16px.lllIIIllIIIIlllIlIIllIIll(((String)this.lllIIIllIIIIlllIlIIllIIll.lIlllIlllIIIIlIIlllIllIII()).toUpperCase(), this.lIlllIlllIIIIlIIlllIllIII + 2, (float)(this.IlIIIIIllllllIIlllIllllll + 2), new Color(1.0f, 1.0f, 1.0f, 0.9f).getRGB());
