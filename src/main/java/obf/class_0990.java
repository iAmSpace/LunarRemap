...
extends class_2117 {
    ...
    public class_0990(class_1609 class_16092, float f) {
        super(f);
    ...
    public void lllIIIllIIIIlllIlIIllIIll(int n, int n2, float f) {
        ...
        if (this.IllIIIllIIIIlIlIlIllIIlll == 0) {
            LunarClient.getInstance().ubuntuMedium16px.lllIlIIlIIIlIlIIIllIlllIl((Boolean)this.lllIIIllIIIIlllIlIIllIIll.lIlllIlllIIIIlIIlllIllIII() != false ? "ON" : "OFF", this.lIlllIlllIIIIlIIlllIllIII + this.lIllllIIlIIIlIllllllIIIll - 48, this.IlIIIIIllllllIIlllIllllll + 2, Color.WHITE.getRGB());
        } else {
            ...
            if (bl3) {
                LunarClient.getInstance().ubuntuMedium16px.lllIlIIlIIIlIlIIIllIlllIl((Boolean)this.lllIIIllIIIIlllIlIIllIIll.lIlllIlllIIIIlIIlllIllIII() != false ? "ON" : "OFF", (float)(this.lIlllIlllIIIIlIIlllIllIII + this.lIllllIIlIIIlIllllllIIIll - 98) + this.lIIIIlIlIIlllllIIllIIlIII, this.IlIIIIIllllllIIlllIllllll + 2, Color.LIGHT_GRAY.getRGB());
            } else {
                LunarClient.getInstance().ubuntuMedium16px.lllIlIIlIIIlIlIIIllIlllIl((Boolean)this.lllIIIllIIIIlllIlIIllIIll.lIlllIlllIIIIlIIlllIllIII() != false ? "ON" : "OFF", (float)(this.lIlllIlllIIIIlIIlllIllIII + this.lIllllIIlIIIlIllllllIIIll + 2) - this.lIIIIlIlIIlllllIIllIIlIII, this.IlIIIIIllllllIIlllIllllll + 2, Color.LIGHT_GRAY.getRGB());
            }
    ...
    public void lllIIIllIIIIlllIlIIllIIll(int n, int n2, int n3) {
        ...
        if ((bl || bl2) && this.IllIIIllIIIIlIlIlIllIIlll == 0) {
            ...
            this.lIIIIlIlIIlllllIIllIIlIII = 0.0f;
            this.llIIlllIllIllllIIIlIIIIII = (Boolean)this.lllIIIllIIIIlllIlIIllIIll.lIlllIlllIIIIlIIlllIllIII() != false ? "ON" : "OFF";
            ...
            this.lllIIIllIIIIlllIlIIllIIll.lllIlIIlIIIlIlIIIllIlllIl((Boolean)this.lllIIIllIIIIlllIlIIllIIll.lIlllIlllIIIIlIIlllIllIII() == false);
            ...
            } else if (this.lllIIIllIIIIlllIlIIllIIll == LunarClient.getInstance().getSettingsManager().IIlllIlIlllIllIIIlllIIlIl && !((Boolean) LunarClient.getInstance().getSettingsManager().IIlllIlIlllIllIIIlllIIlIl.lIlllIlllIIIIlIIlllIllIII()).booleanValue()) {
