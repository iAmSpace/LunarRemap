...
public class class_1830
extends class_0608 {
    public class_1830() {
    }

    public class_1830(int n, Random random, class_2046 class_20462, int n2) {
        super(n);
    ...
    public static class_1830 lllIIIllIIIIlllIlIIllIIll(List list, Random random, int n, int n2, int n3, int n4, int n5) {
        class_2046 class_20462 = class_2046.lllIIIllIIIIlllIlIIllIIll(n, n2, n3, -1, 0, 0, 5, 7, 5, n4);
        return class_1830.lllIIIllIIIIlllIlIIllIIll(class_20462) && class_1036.lllIIIllIIIIlllIlIIllIIll(list, class_20462) == null ? new class_1830(n5, random, class_20462, n4) : null;
    }
