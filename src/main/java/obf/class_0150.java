...
extends class_0703 {
     ...
     */
    public class_0150(class_0723 class_07232, boolean bl, int n) {
        ...
        class_0537 class_05372 = class_0150.lllIIIllIIIIlllIlIIllIIll(class_07232, bl, n);
    ...
    public static class_0537 lllIIIllIIIIlllIlIIllIIll(class_0723 class_07232, boolean bl, int n) {
        ...
        for (n2 = 0; n2 < arrclass_1532.length; ++n2) {
            ...
            System.arraycopy(object.lllIIIllIIIIlllIlIIllIIll, 0, arrby, n3, object.lllIIIllIIIIlllIlIIllIIll.length);
            n3 += object.lllIIIllIIIIlllIlIIllIIll.length;
        }
        for (n2 = 0; n2 < arrclass_1532.length; ++n2) {
            if (arrclass_1532[n2] == null || bl && arrclass_1532[n2].lllIIIllIIIIlllIlIIllIIll() || (n & 1 << n2) == 0) continue;
