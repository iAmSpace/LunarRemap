...
extends class_0608 {
    ...
    public class_0055(int n, Random random, class_2046 class_20462, int n2) {
        super(n);
    ...
    public static class_0055 lllIIIllIIIIlllIlIIllIIll(List list, Random random, int n, int n2, int n3, int n4, int n5) {
        class_2046 class_20462 = class_2046.lllIIIllIIIIlllIlIIllIIll(n, n2, n3, -1, 0, 0, 5, 7, 5, n4);
        return class_0055.lllIIIllIIIIlllIlIIllIIll(class_20462) && class_1036.lllIIIllIIIIlllIlIIllIIll(list, class_20462) == null ? new class_0055(n5, random, class_20462, n4) : null;
    }
    ...
    public boolean lllIIIllIIIIlllIlIIllIIll(class_1334 class_13342, Random random, class_2046 class_20462) {
        ...
        this.lllIIIllIIIIlllIlIIllIIll(class_13342, class_20462, 4, 2, 0, 4, 5, 4, Blocks.llIllIllIllIlIlIllIlIIIIl, Blocks.llIllIllIllIlIlIllIlIIIIl, false);
        this.lllIIIllIIIIlllIlIIllIIll(class_13342, class_20462, 4, 3, 1, 4, 4, 1, Blocks.lllIlIIllllIllIIIlIlIIIll, Blocks.lllIlIIllllIllIIIlIlIIIll, false);
        this.lllIIIllIIIIlllIlIIllIIll(class_13342, class_20462, 4, 3, 3, 4, 4, 3, Blocks.lllIlIIllllIllIIIlIlIIIll, Blocks.lllIlIIllllIllIIIlIlIIIll, false);
        ...
        this.lllIIIllIIIIlllIlIIllIIll(class_13342, class_20462, 0, 2, 4, 3, 5, 4, Blocks.llIllIllIllIlIlIllIlIIIIl, Blocks.llIllIllIllIlIlIllIlIIIIl, false);
        ...
        if (this.lllIlIIlIIIlIlIIIllIlllIl) {
            ...
            n = this.lllIIIllIIIIlllIlIIllIIll(3, 3);
            if (class_20462.lllIlIIlIIIlIlIIIllIlllIl(n, n2, n3 = this.lllIlIIlIIIlIlIIIllIlllIl(3, 3))) {
                this.lllIlIIlIIIlIlIIIllIlllIl = false;
                this.lllIIIllIIIIlllIlIIllIIll(class_13342, class_20462, random, 3, 2, 3, lllIIIllIIIIlllIlIIllIIll, 2 + random.nextInt(4));
            }
        }
