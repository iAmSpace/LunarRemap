...
extends class_1000 {
                            ...
                            for (n7 = n13; n7 < n14; ++n7) {
                                ...
                                for (int i = n12 - 1; i >= n11; --i) {
                                    ...
                                    if (d15 > -0.7 && d13 * d13 + d15 * d15 + d14 * d14 < 1.0) {
                                        Block class_05493 = arrclass_0549[n15];
                                        ...
                                        if (class_05493 == Blocks.lllIlIIlIIIlIlIIIllIlllIl || class_05493 == Blocks.lIlllIlllIIIIlIIlllIllIII || class_05493 == Blocks.IlIllllllIIlIIllllIIlIIIl) {
                                            if (i < 10) {
                                                arrclass_0549[n15] = Blocks.llIIlllIllIllllIIIlIIIIII;
                                            } else {
                                                arrclass_0549[n15] = null;
                                                if (bl4 && arrclass_0549[n15 - 1] == Blocks.lIlllIlllIIIIlIIlllIllIII) {
                                                    arrclass_0549[n15 - 1] = this.IlIllllllIIlIIllllIIlIIIl.a_((int)(n8 + n * 16), (int)(n7 + n2 * 16)).IlllIIIllllIIllIllIlIIlIl;
                                                }
                                            }
                                        }
                                    }
    ...
    protected void lllIIIllIIIIlllIlIIllIIll(class_1334 class_13342, int n, int n2, int n3, int n4, Block[] arrclass_0549) {
        int n5 = this.lllIlIIlIIIlIlIIIllIlllIl.nextInt(this.lllIlIIlIIIlIlIIIllIlllIl.nextInt(this.lllIlIIlIIIlIlIIIllIlllIl.nextInt(15) + 1) + 1);
        if (this.lllIlIIlIIIlIlIIIllIlllIl.nextInt(7) != 0) {
            n5 = 0;
        }
        for (int i = 0; i < n5; ++i) {
            double d = n * 16 + this.lllIlIIlIIIlIlIIIllIlllIl.nextInt(16);
            double d2 = this.lllIlIIlIIIlIlIIIllIlllIl.nextInt(this.lllIlIIlIIIlIlIIIllIlllIl.nextInt(120) + 8);
            ...
            for (int j = 0; j < n6; ++j) {
                ...
                if (this.lllIlIIlIIIlIlIIIllIlllIl.nextInt(10) == 0) {
                    f3 *= this.lllIlIIlIIIlIlIIIllIlllIl.nextFloat() * this.lllIlIIlIIIlIlIIIllIlllIl.nextFloat() * 3.0f + 1.0f;
                }
                this.lllIIIllIIIIlllIlIIllIIll(this.lllIlIIlIIIlIlIIIllIlllIl.nextLong(), n3, n4, arrclass_0549, d, d2, d3, f3, f, f2, 0, 0, 1.0);
            }
        }
    }
}
