...
extends Item {
    ...
    private final class_0557 IlIlIIlIlIllIIlIlIIllIIIl;
    private class_2102 lllllIlllIIllIlIIlIIIllII;
    private class_2102 IlIlIIlllIIlIllIIIlllllIl;

    public class_0981(class_0557 class_05572, int n, int n2) {
        this.IlIlIIlIlIllIIlIlIIllIIIl = class_05572;
        this.IllIIIllIIIIlIlIlIllIIlll = n2;
        this.llIIlllIllIllllIIIlIIIIII = n;
        this.lIIIIlIlIIlllllIIllIIlIII = class_05572.lllIlIIlIIIlIlIIIllIlllIl(n2);
        this.IlIIIIIllllllIIlllIllllll(class_05572.lllIIIllIIIIlllIlIIllIIll(n2));
    ...
    public boolean IlIlIIlIlIllIIlIlIIllIIIl() {
        return this.IlIlIIlIlIllIIlIlIIllIIIl == class_0557.lllIIIllIIIIlllIlIIllIIll;
    }

    @Override
    public int IlIlllIIIIIIlIIllIIllIlll() {
        return this.IlIlIIlIlIllIIlIlIIllIIIl.lllIIIllIIIIlllIlIIllIIll();
    }

    public class_0557 IlIIIlIIIIllIIIllIIIIIIll() {
        return this.IlIlIIlIlIllIIlIlIIllIIIl;
    }

    public boolean llIIllIllIlIIlIIllIllllll(ItemStack class_08972) {
        return this.IlIlIIlIlIllIIlIlIIllIIIl != class_0557.lllIIIllIIIIlllIlIIllIIll ? false : (!class_08972.IlIlIIlIlIllIIlIlIIllIIIl() ? false : (!class_08972.lllllIlllIIllIlIIlIIIllII().lllIlIIlIIIlIlIIIllIlllIl("display", 10) ? false : class_08972.lllllIlllIIllIlIIlIIIllII().llIIllIllIlIIlIIllIllllll("display").lllIlIIlIIIlIlIIIllIlllIl("color", 3)));
    }

    public int lllIIlIIIllllllIIIIlIlIlI(ItemStack class_08972) {
        if (this.IlIlIIlIlIllIIlIlIIllIIIl != class_0557.lllIIIllIIIIlllIlIIllIIll) {
            return -1;
        }
    ...
    public void IlIlllIIIIIIlIIllIIllIlll(ItemStack class_08972) {
        ...
        if (this.IlIlIIlIlIllIIlIlIIllIIIl == class_0557.lllIIIllIIIIlllIlIIllIIll && (class_07753 = class_08972.lllllIlllIIllIlIIlIIIllII()) != null && (class_07752 = class_07753.llIIllIllIlIIlIIllIllllll("display")).IlIllllllIIlIIllllIIlIIIl("color")) {
    ...
    public boolean lllIIIllIIIIlllIlIIllIIll(ItemStack class_08972, ItemStack class_08973) {
        return this.IlIlIIlIlIllIIlIlIIllIIIl.lllIlIIlIIIlIlIIIllIlllIl() == class_08973.lllIIIllIIIIlllIlIIllIIll() ? true : super.lllIIIllIIIIlllIlIIllIIll(class_08972, class_08973);
    }
    ...
    public static class_2102 lIllllIIlIIIlIllllllIIIll(int n) {
        switch (n) {
            case 0: {
    ...
    static /* synthetic */ int[] IIlllIlIlllIllIIIlllIIlIl() {
