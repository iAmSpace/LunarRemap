...
extends class_0703 {
    ...
    public class_1178(String string, float f, float f2, float f3, float f4, float f5, float f6, float f7, int n) {
    ...
    public void lllIIIllIIIIlllIlIIllIIll(class_0181 class_01812) {
        this.lllIIIllIIIIlllIlIIllIIll = class_01812.IlIllllllIIlIIllllIIlIIIl(64);
