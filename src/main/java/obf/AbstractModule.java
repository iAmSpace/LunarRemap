...
public class AbstractModule {
    ...
    private List<Setting> IIIllIllIIlIlIlIlIllllIIl;
    private List IllIIIllIIIIlIlIlIllIIlll;
    public Setting llIIlIlIlllIIllIlIlllIllI;
    private final Map<Class<? extends Event>, Consumer> eventMap;
    ...
    public AbstractModule(String string) {
        ...
        this.llIIlIlIlllIIllIlIlllIllI = new Setting(this, "Scale").setValue(1.0f).setMinMax(0.5f, 1.5f);
    }

    protected void lllIIIllIIIIlllIlIIllIIll(Class class_, Consumer consumer) {
        this.eventMap.put(class_, consumer);
    }

    protected void addAllEvents() {
        for (Map.Entry<Class<? extends Event>, Consumer> entry : this.eventMap.entrySet()) {
            LunarClient.getInstance().getEventBus().addEvent(entry.getKey(), entry.getValue());
        }
    }

    protected void removeAllEvents() {
        for (Map.Entry<Class<? extends Event>, Consumer> entry : this.eventMap.entrySet()) {
            LunarClient.getInstance().getEventBus().removeEvent(entry.getKey(), entry.getValue());
        }
    }
    ...
    public List<Setting> llIIlllIllIllllIIIlIIIIII() {
    ...
    public void lllIIIllIIIIlllIlIIllIIll(class_0321 class_03212, float f, float f2) {
        float f3 = 0.0f;
        float f4 = 0.0f;
        GL11.glScalef((float)((Float)this.llIIlIlIlllIIllIlIlllIllI.getValue()).floatValue(), (float)((Float)this.llIIlIlIlllIIllIlIlllIllI.getValue()).floatValue(), (float)((Float)this.llIIlIlIlllIIllIlIlllIllI.getValue()).floatValue());
        f *= ((Float)this.llIIlIlIlllIIllIlIlllIllI.getValue()).floatValue();
        f2 *= ((Float)this.llIIlIlIlllIIllIlIlllIllI.getValue()).floatValue();
        ...
        GL11.glTranslatef((float)(f3 / ((Float)this.llIIlIlIlllIIllIlIlllIllI.getValue()).floatValue()), (float)(f4 / ((Float)this.llIIlIlIlllIIllIlIlllIllI.getValue()).floatValue()), (float)0.0f);
        GL11.glTranslatef((float)(this.lIllllIIlIIIlIllllllIIIll / ((Float)this.llIIlIlIlllIIllIlIlllIllI.getValue()).floatValue()), (float)(this.IIIllIIlIIIIIIlIlIIllIIlI / ((Float)this.llIIlIlIlllIIllIlIlllIllI.getValue()).floatValue()), (float)0.0f);
    }

    public float[] lllIIIllIIIIlllIlIIllIIll(class_0321 class_03212, boolean bl) {
        float f = 0.0f;
        float f2 = 0.0f;
        float f3 = this.llIllllIlIllIIIlIllIIlIlI * ((Float)this.llIIlIlIlllIIllIlIlllIllI.getValue()).floatValue();
        float f4 = this.lIlllIlllIlIIIIlllIlIlIIl * ((Float)this.llIIlIlIlllIIllIlIlllIllI.getValue()).floatValue();
        switch (this.IlIIIIIllllllIIlllIllllll) {
            case lllIIIllIIIIlllIlIIllIIll: {
                f = 2.0f;
                f2 = 2.0f;
        ...
        return new float[]{(f + (bl ? this.lIllllIIlIIIlIllllllIIIll : 0.0f)) / ((Float)this.llIIlIlIlllIIllIlIlllIllI.getValue()).floatValue(), (f2 + (bl ? this.IIIllIIlIIIIIIlIlIIllIIlI : 0.0f)) / ((Float)this.llIIlIlIlllIIllIlIlllIllI.getValue()).floatValue()};
    }
