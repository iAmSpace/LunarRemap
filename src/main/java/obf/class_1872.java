 ...
 */
public class class_1872
extends class_0323 {
    private int lllIIIllIIIIlllIlIIllIIll = 128;

    public class_1872(class_1334 class_13342, double d, double d2, double d3, double d4, double d5, double d6) {
