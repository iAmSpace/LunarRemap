...
implements class_2098 {
    ...
    public boolean lllIIIllIIIIlllIlIIllIIll(class_0013 class_00132, class_1334 class_13342) {
        ...
        for (int i = 0; i < class_00132.IlIIIIIllllllIIlllIllllll(); ++i) {
            ...
            if (class_08973.lllIIIllIIIIlllIlIIllIIll() == Items.IIIIIlllIIllllIlllIlllIIl) {
                if (class_08972 != null) {
                    return false;
                }
            ...
            if (class_08973.lllIIIllIIIIlllIlIIllIIll() != Items.lIlIIIlIlIllIlIlIIIlIlIII) {
                return false;
            }
            ++n;
        }
    ...
    public ItemStack lllIIIllIIIIlllIlIIllIIll(class_0013 class_00132) {
        ...
        if (class_08972 != null && n >= 1) {
            ItemStack class_08974 = new ItemStack(Items.IIIIIlllIIllllIlllIlllIIl, n + 1, class_08972.IllIIIllIIIIlIlIlIllIIlll());
