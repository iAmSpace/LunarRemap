...
public class class_0936 {
    ...
    public static byte[] lllIIIllIIIIlllIlIIllIIll(String string, PublicKey publicKey, SecretKey secretKey) {
        try {
            return class_0936.lllIIIllIIIIlllIlIIllIIll("SHA-1", string.getBytes("ISO_8859_1"), secretKey.getEncoded(), publicKey.getEncoded());
        }
    ...
    public static SecretKey lllIIIllIIIIlllIlIIllIIll(PrivateKey privateKey, byte[] arrby) {
        return new SecretKeySpec(class_0936.lllIlIIlIIIlIlIIIllIlllIl(privateKey, arrby), "AES");
    }

    public static byte[] lllIIIllIIIIlllIlIIllIIll(Key key, byte[] arrby) {
        return class_0936.lllIIIllIIIIlllIlIIllIIll(1, key, arrby);
    }

    public static byte[] lllIlIIlIIIlIlIIIllIlllIl(Key key, byte[] arrby) {
        return class_0936.lllIIIllIIIIlllIlIIllIIll(2, key, arrby);
    }

    private static byte[] lllIIIllIIIIlllIlIIllIIll(int n, Key key, byte[] arrby) {
        try {
            return class_0936.lllIIIllIIIIlllIlIIllIIll(n, key.getAlgorithm(), key).doFinal(arrby);
        }
