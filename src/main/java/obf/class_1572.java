...
extends RecursiveAction {
    ...
    public class_1572(int[] arrn, int n, int n2) {
    ...
    protected void compute() {
        ...
        if (n4 < 8192) {
            class_1741.IIIllIIlIIIIIIlIlIIllIIlI(arrn, this.lllIlIIlIIIlIlIIIllIlllIl, this.IlIllllllIIlIIllllIIlIIIl);
            return;
        }
        ...
        int n8 = n4 / 8;
        n6 = class_1741.lIlllIlllIIIIlIIlllIllIII(arrn, n6, n6 + n8, n6 + 2 * n8);
        n5 = class_1741.lIlllIlllIIIIlIIlllIllIII(arrn, n5 - n8, n5, n5 + n8);
        n7 = class_1741.lIlllIlllIIIIlIIlllIllIII(arrn, n7 - 2 * n8, n7 - n8, n7);
        n5 = class_1741.lIlllIlllIIIIlIIlllIllIII(arrn, n6, n5, n7);
        int n9 = arrn[n5];
        int n10 = n3 = this.lllIlIIlIIIlIlIIIllIlllIl;
        int n11 = n2 = this.IlIllllllIIlIIllllIIlIIIl - 1;
        while (true) {
            if (n10 <= n2 && (n = Integer.compare(arrn[n10], n9)) <= 0) {
                if (n == 0) {
            ...
            while (n2 >= n10 && (n = Integer.compare(arrn[n2], n9)) >= 0) {
                if (n == 0) {
        ...
        n = n11 - n2;
        if (n8 > 1 && n > 1) {
            class_1572.invokeAll(new class_1572(arrn, this.lllIlIIlIIIlIlIIIllIlllIl, this.lllIlIIlIIIlIlIIIllIlllIl + n8), new class_1572(arrn, this.IlIllllllIIlIIllllIIlIIIl - n, this.IlIllllllIIlIIllllIIlIIIl));
        } else if (n8 > 1) {
            class_1572.invokeAll(new class_1572(arrn, this.lllIlIIlIIIlIlIIIllIlllIl, this.lllIlIIlIIIlIlIIIllIlllIl + n8));
        } else {
            class_1572.invokeAll(new class_1572(arrn, this.IlIllllllIIlIIllllIIlIIIl - n, this.IlIllllllIIlIIllllIIlIIIl));
        }
    }
}
