...
extends class_2117 {
    ...
    public class_1388(class_1609 class_16092, float f) {
        super(f);
        this.lllIIIllIIIIlllIlIIllIIll = class_16092;
        this.IIIllIIlIIIIIIlIlIIllIIlI = 12;
        this.IllIIlllllllIIlIIlIIIIlIl = new class_0527(LunarClient.getInstance().robotoLight18px, null, Keyboard.getKeyName((int)((Integer)class_16092.lIlllIlllIIIIlIIlllIllIII())), this.lIlllIlllIIIIlIIlllIllIII + this.lIllllIIlIIIlIllllllIIIll - 100, this.IlIIIIIllllllIIlllIllllll, 96, 18, -9442858, f);
    }
    ...
    public void lllIIIllIIIIlllIlIIllIIll(int n, int n2, float f) {
        ...
        LunarClient.getInstance().ubuntuMedium16px.lllIIIllIIIIlllIlIIllIIll(this.lllIIIllIIIIlllIlIIllIIll.lIllllIIlIIIlIllllllIIIll().toUpperCase(), this.lIlllIlllIIIIlIIlllIllIII + 10, (float)(this.IlIIIIIllllllIIlllIllllll + 4), bl2 || bl ? -1090519040 : -1895825408);
        if (this.IIIllIllIIlIlIlIlIllllIIl && Keyboard.getEventKeyState()) {
            ...
            this.lllIIIllIIIIlllIlIIllIIll.lllIlIIlIIIlIlIIIllIlllIl(Keyboard.getEventKey());
            this.IllIIlllllllIIlIIlIIIIlIl.IllIIlllllllIIlIIlIIIIlIl = Keyboard.getKeyName((int)((Integer)this.lllIIIllIIIIlllIlIIllIIll.lIlllIlllIIIIlIIlllIllIII()));
