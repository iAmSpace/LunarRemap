...
extends class_0079 {
    ...
    public class_2035(class_1681 class_16812, Minecraft class_06672) {
        ...
        Object[] arrobject = (KeyBinding[])ArrayUtils.clone((Object[])class_06672.gameSettings.keyBindings);
        this.llIIllIllIlIIlIIllIllllll = new class_0677[arrobject.length + KeyBinding.IlIllllllIIlIIllllIIlIIIl().size()];
        ...
        for (int i = 0; i < n2; ++i) {
            ...
            String string2 = ((KeyBinding)object).IlIIIIIllllllIIlllIllllll();
            if (!string2.equals(string)) {
                string = string2;
                this.llIIllIllIlIIlIIllIllllll[n++] = new class_1836(this, string2);
            }
            if ((n3 = class_06672.IlIlllIIIIIIlIIllIIllIlll.lllIIIllIIIIlllIlIIllIIll(class_0616.lllIIIllIIIIlllIlIIllIIll(((KeyBinding)object).IIIllIIlIIIIIIlIlIIllIIlI(), new Object[0]))) > this.lllIIlIIIllllllIIIIlIlIlI) {
                this.lllIIlIIIllllllIIIIlIlIlI = n3;
            }
            this.llIIllIllIlIIlIIllIllllll[n++] = new class_1285(this, (KeyBinding)object, null);
        }
    }
