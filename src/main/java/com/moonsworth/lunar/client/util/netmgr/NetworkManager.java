package com.moonsworth.lunar.client.util.netmgr;/*
...
implements ILCNetHandlerClient {
    ...
    public void onPluginMessage(PluginMessageEvent e) {
        try {
            if (e.getChannel().equals("REGISTER")) {
                String string = new String(e.getPayload(), Charsets.UTF_8);
                ...
                if (Minecraft.getMinecraft().llIIlIllIllllIlIIIIlIIlll() != null && this.lllIlIIlIIIlIlIIIllIlllIl) {
                    Minecraft.getMinecraft().llIIlIllIllllIlIIIIlIIlll().lllIIIllIIIIlllIlIIllIIll(new C17PacketCustomPayload("REGISTER", class_01812));
                }
                this.lIIIIlIlIIlllllIIllIIlIII();
            } else if (e.getChannel().equals(LunarClient.getInstance().lllIIIllIIIIlllIlIIllIIll())) {
                LCPacket lCPacket = LCPacket.handle((byte[])e.getPayload());
                ...
                if (LunarClient.getInstance().getSettingsManager().IllIIlllllllIIlIIlIIIIlIl) {
                    ...
                    class_0722 class_07223 = new class_0722((Object)((Object) EnumChatFormatting.GRAY) + "Received: " + (Object)((Object) EnumChatFormatting.WHITE) + lCPacket.getClass().getSimpleName());
                    class_07223.lllIlIIlIIIlIlIIIllIlllIl().lllIIIllIIIIlllIlIIllIIll(new class_0015(class_0248.SHOW_TEXT, new class_0722(new Gson().toJson((Object)lCPacket))));
    ...
    private void lIIIIlIlIIlllllIIllIIlIII() {
        ...
        for (AbstractModule class_16652 : LunarClient.getInstance().getModuleManager().staffModules) {
    ...
    public void lllIIIllIIIIlllIlIIllIIll(LCPacket lCPacket) {
        ...
        if (lCPacket != null && LunarClient.getInstance().getSettingsManager().IllIIlllllllIIlIIlIIIIlIl) {
            object = new class_0722((Object)((Object) EnumChatFormatting.RED) + "[LC] " + (Object)((Object) EnumChatFormatting.RESET));
            class_0722 class_07222 = new class_0722((Object)((Object) EnumChatFormatting.GRAY) + "Sent: " + (Object)((Object) EnumChatFormatting.WHITE) + lCPacket.getClass().getSimpleName());
            class_07222.lllIlIIlIIIlIlIIIllIlllIl().lllIIIllIIIIlllIlIIllIIll(new class_0015(class_0248.SHOW_TEXT, new class_0722(new Gson().toJson((Object)lCPacket))));
        ...
        object = new C17PacketCustomPayload(this.lllIIIllIIIIlllIlIIllIIll.lllIIIllIIIIlllIlIIllIIll(), LCPacket.getPacketData((LCPacket)lCPacket));
        Minecraft.getMinecraft().lIIIIlIlIIlllllIIllIIlIII.lllIlIIlIIIlIlIIIllIlllIl.lllIIIllIIIIlllIlIIllIIll((Packet)object);
    }
    ...
    public void handleStaffModState(LCPacketStaffModState lCPacketStaffModState) {
        for (AbstractModule class_16652 : this.lllIIIllIIIIlllIlIIllIIll.getModuleManager().staffModules) {
    ...
    public void handleTeammates(LCPacketTeammates lCPacketTeammates) {
        ...
        if (!((Boolean)this.lllIIIllIIIIlllIlIIllIIll.getSettingsManager().tvEnableTeamView.getValue()).booleanValue() || map == null || map.isEmpty() || map.size() == 1 && map.containsKey(Minecraft.getMinecraft().lIIIIlIlIIlllllIIllIIlIII.lIIlllIIlIlIlIIIlIlllIIll())) {
            this.lllIIIllIIIIlllIlIIllIIll.getModuleManager().IIlllIlIlllIllIIIlllIIlIl.lllIIIllIIIIlllIlIIllIIll().clear();
            return;
        }
        int n = 0;
        ...
        switch (lCPacketVoiceChannelUpdate.getStatus()) {
            ...
            case 2: {
                if (lCPacketVoiceChannelUpdate.getUuid().toString().equals(Minecraft.getMinecraft().getSession().getPlayerID())) {
                    ...
                    class_0722 class_07222 = new class_0722((Object)((Object) EnumChatFormatting.AQUA) + "Joined " + class_19502.lllIlIIlIIIlIlIIIllIlllIl() + " channel. Press '" + Keyboard.getKeyName((int)this.lllIIIllIIIIlllIlIIllIIll.getSettingsManager().keyVoiceChat.IIIllIllIIlIlIlIlIllllIIl()) + "' to talk!" + (Object)((Object) EnumChatFormatting.RESET));
                    Minecraft.getMinecraft().IlIIIlIIIIllIIIllIIIIIIll.lllIlIIlIIIlIlIIIllIlllIl().lllIIIllIIIIlllIlIIllIIll(class_07222);
                } else if (this.IIIllIIlIIIIIIlIlIIllIIlI == class_19502) {
                    class_0722 class_07223 = new class_0722((Object)((Object) EnumChatFormatting.AQUA) + lCPacketVoiceChannelUpdate.getName() + (Object)((Object) EnumChatFormatting.AQUA) + " joined " + class_19502.lllIlIIlIIIlIlIIIllIlllIl() + " channel. Press '" + Keyboard.getKeyName((int)this.lllIIIllIIIIlllIlIIllIIll.getSettingsManager().keyOpenVoiceMenu.IIIllIllIIlIlIlIlIllllIIl()) + "'!" + (Object)((Object) EnumChatFormatting.RESET));
            ...
            case 3: {
                if (this.IIIllIIlIIIIIIlIlIIllIIlI == class_19502 && !lCPacketVoiceChannelUpdate.getUuid().toString().equals(Minecraft.getMinecraft().getSession().getPlayerID())) {
                    class_0722 class_07224 = new class_0722((Object)((Object) EnumChatFormatting.AQUA) + lCPacketVoiceChannelUpdate.getName() + (Object)((Object) EnumChatFormatting.AQUA) + " left " + class_19502.lllIlIIlIIIlIlIIIllIlllIl() + " channel. Press '" + Keyboard.getKeyName((int)this.lllIIIllIIIIlllIlIIllIIll.getSettingsManager().keyOpenVoiceMenu.IIIllIllIIlIlIlIlIllllIIl()) + "'!" + (Object)((Object) EnumChatFormatting.RESET));
    ...
    public void handleServerUpdate(LCPacketServerUpdate lCPacketServerUpdate) {
        ...
        LunarClient.getInstance().updateRichPresence(Minecraft.getMinecraft().IlIllllllIIlIIllllIIlIIIl.lllIlIIlIIIlIlIIIllIlllIl, lCPacketServerUpdate.getServer(), false);
    }
