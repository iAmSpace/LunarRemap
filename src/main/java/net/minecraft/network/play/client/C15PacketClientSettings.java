...
extends Packet {
    ...
    public C15PacketClientSettings(String string, int n, class_1210 class_12102, boolean bl, class_1999 class_19992, boolean bl2) {
    ...
    public void readPacketData(PacketBuffer class_01812) {
        this.lllIIIllIIIIlllIlIIllIIll = class_01812.readStringFromBuffer(7);
