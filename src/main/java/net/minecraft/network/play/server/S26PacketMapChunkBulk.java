...
extends Packet {
    ...
    public S26PacketMapChunkBulk(List list) {
        ...
        for (int i = 0; i < n; ++i) {
            ...
            class_0537 class_05372 = S21PacketChunkData.lllIIIllIIIIlllIlIIllIIll(class_07232, true, 65535);
    ...
    public void readPacketData(PacketBuffer class_01812) throws IOException {
        ...
        byte[] arrby = new byte[S21PacketChunkData.IlIllllllIIlIIllllIIlIIIl() * n];
