...
import net.minecraft.network.play.client.C03PacketPlayer_C04PacketPlayerPosition;
import net.minecraft.network.play.client.C03PacketPlayer_C05PacketPlayerLook;
...
import net.minecraft.network.play.server.S14PacketEntity_S15PacketEntityRelMove;
import net.minecraft.network.play.server.S14PacketEntity_S16PacketEntityLook;
import net.minecraft.network.play.server.S14PacketEntity_S17PacketEntityLookMove;
