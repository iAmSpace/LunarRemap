...
public class Main {
    ...
    public static void lllIIIllIIIIlllIlIIllIIll(String[] arrstring) {
        ...
        if (s != null)
        {
            try
            {
                proxy = new Proxy(Proxy.Type.SOCKS, new InetSocketAddress(s, ((Integer)optionset.valueOf(argumentacceptingoptionspec6)).intValue()));
            }
        ...
        class_1220 session = new class_1220((String)argumentacceptingoptionspec9.value(optionset), s4, (String)argumentacceptingoptionspec11.value(optionset), (String)argumentacceptingoptionspec17.value(optionset));
