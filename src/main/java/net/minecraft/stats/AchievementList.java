...
public class AchievementList {
    ...
    static {
        ...
        cookFish = new Achievement("achievement.cookFish", "cookFish", 2, 6, Items.cooked_fished, buildFurnace).registerStat();
        ...
        field_150966_x = new Achievement("achievement.diamondsToYou", "diamondsToYou", -1, 2, Items.diamond, diamonds).registerStat();
        ...
        field_150962_H = new Achievement("achievement.breedCow", "breedCow", 7, -5, Items.wheat, killCow).registerStat();
        field_150963_I = new Achievement("achievement.spawnWither", "spawnWither", 7, 12, new ItemStack(Items.skull, 1, 1), theEnd2).registerStat();
        field_150964_J = new Achievement("achievement.killWither", "killWither", 7, 10, Items.nether_star, field_150963_I).registerStat();
        field_150965_K = new Achievement("achievement.fullBeacon", "fullBeacon", 7, 8, Blocks.beacon, field_150964_J).setSpecial().registerStat();
        field_150961_L = new Achievement("achievement.exploreAllBiomes", "exploreAllBiomes", 4, 8, Items.diamond_boots, theEnd).func_150953_b(JsonSerializableSet.class).setSpecial().registerStat();
    }
}
